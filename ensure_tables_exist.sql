...
-- Run this BEFORE fix_all_demo_issues.sql
...
-- Create selected_projects table if it doesn't exist
...
-- Create data_fetch_status table if it doesn't exist
...
-- Add unique constraint for usage_data
