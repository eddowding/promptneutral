...
-- Create enhanced usage_data table
...
CREATE INDEX idx_api_keys_service ON api_keys(user_id, service);
...
CREATE INDEX idx_usage_data_endpoint ON usage_data(endpoint);
CREATE INDEX idx_usage_data_date_user ON usage_data(date, user_id);
